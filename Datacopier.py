...
# =====================================================
# UPDATED SOURCE REPO PATH
# =====================================================
SOURCE_FOLDER_PATH = "Stock_Scanner_With_ASTA_Parameters-main/market_data"

BASE_DIR = SOURCE_FOLDER_PATH
...
# =====================================================
# LOCAL FNO SOURCE FOLDERS (INSIDE SAME REPO)
# =====================================================
LOCAL_FNO_PATHS = {
    "15m": os.path.join(BASE_DIR, "stock_data_15"),
    "1H": os.path.join(BASE_DIR, "stock_data_1H"),
    "D": os.path.join(BASE_DIR, "stock_data_D"),
    "W": os.path.join(BASE_DIR, "stock_data_W"),
    "M": os.path.join(BASE_DIR, "stock_data_M"),
}
